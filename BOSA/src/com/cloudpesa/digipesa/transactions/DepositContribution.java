...
public class DepositContribution {
    public void contriScreen() {
        showScreen("Deposit Contribution", createDepositScreen());
    }
            ...
            public void actionPerformed(ActionEvent evt) {
                if(txt_Amt.getText().equals("")){
                    ...
                    if(Double.parseDouble(Amount) < 1){
                        ...
                        try {transact("Deposit Contribution" /*"Normal Shares"*/, Amount.toString());} catch (IOException ex) {}
                    }
                }
            }
        });
